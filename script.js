...
function buildTopbar(active){
  return `<div class="topbar"><div class="container topbar-inner">
    ...
    <nav class="nav">
      ...
      <a href="favorites.html" class="${active==='favs'?'active':''}">โปรด ❤️</a>
  ...
  document.body.innerHTML=`
    ...
    <div class="container"><div class="hero">
      ...
      <div class="card" style="margin-bottom:14px">
        ...
        <p style="font-size:13px;color:var(--muted);margin-bottom:14px">มีข้อเสนอแนะ พบบั๊ก หรืออยากแนะนำฟีเจอร์ใหม่? กรอกแบบฟอร์มได้เลยครับ ไม่ต้องเปิดเผยตัวตน 😊</p>
        <a href="https://docs.google.com/forms/d/e/1FAIpQLSclpZ1aILFECVXQBD_Jhxw-Bmttk_WZt-80TB7jNzERwOw8Qg/viewform" target="_blank" class="btn btn-primary" style="width:100%;justify-content:center;gap:10px;padding:14px;font-size:15px">
          <span style="font-size:22px">📝</span>
          <span>กรอกแบบฟอร์มติดต่อเรา</span>
        </a>
      </div>
